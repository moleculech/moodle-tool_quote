...
/**
 * Provides {@link block_quote\external\list_exporter} class.
 *
 * @package     block_quote
...
/**
 * Exporter of the quote list items.
 */
class list_exporter extends exporter {
     ...
     *
     * We need the context to be used when formatting the quotetext field.
     *
     * @return array
     */
