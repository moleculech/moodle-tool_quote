...
class item_added extends \core\event\base {
    protected function init() {
        ...
        $this->data['objecttable'] = 'block_quote';
    }

    public static function get_name() {
        return get_string('eventitemadded', 'block_quote');
    }

    public function get_description() {
        return "The user with id {$this->userid} created a quote item with id {$this->objectid}.";
    }
